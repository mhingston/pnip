...
const configSchema = z.object({
  ...
  DIGEST_MAX_STORIES: z.coerce.number().int().positive().default(25),
  DIGEST_MAX_STORIES_PER_SOURCE: z.coerce.number().int().positive().default(8),
  DIGEST_MAX_DOCUMENTS_PER_SOURCE: z.coerce.number().int().positive().default(12),
